...
> Upload statement data, review classifications, reconcile the period, then export a CPA-reviewable cash-basis financial package.
...
- P&L and simplified cash-basis statement of position/reporting package.
...
The reports are cash-basis activity reports generated from transaction movements and statement balances. The UI and exports must clearly state that they are not a full accounting ledger and not a substitute for CPA review.
...
- Cover and disclosures.
- P&L.
- Simplified cash-basis position report.
- Transaction detail.
...
- LLC name.
- Property name or LLC-wide scope.
- Report period.
- Generated date.
- Generated by user.
- Statement that reports are based on uploaded statement activity, user-entered balances, and user/user-approved classifications.
...
- Final export includes required workbook tabs and disclosures.
