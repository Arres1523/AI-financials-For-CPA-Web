    ...
    <form className="space-y-3" onSubmit={handleSubmit}>
      <div>
        ...
        <input
          ...
          className="w-full border border-line bg-white px-3 py-2 text-sm outline-none transition focus:border-sage"
          autoComplete="email"
          required
        />
      </div>
      ...
      <button
        type="submit"
        className="w-full bg-ink px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
