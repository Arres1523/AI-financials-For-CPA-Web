...
export default function StepIndicator({ steps, onStepClick }: { steps: Step[]; onStepClick?: (id: number) => void }) {
  return (
        ...
        {steps.map((step) => (
          <li key={step.id}>
            <button
              ...
              className={`flex min-h-11 w-full items-center gap-2 border border-line px-3 py-2 text-left ${
